...
<%--        <form:form id="startStop" method="post" modelAttribute="startStopParams">--%>
        ...
        <c:forEach items="${txDetails}" var="txD">
            ...
            <table class="userInput">
                ...
                <tr><td><div class="submit-button"><input style="background: green; color: whitesmoke" value="Start"></div></td>
                <td><div  class="submit-button"><input style="background: red; color: whitesmoke" value="Stop"></div></td></tr>
            </table>
        </form:form>
    </div>
<%--        <div class="op16-content">--%>
