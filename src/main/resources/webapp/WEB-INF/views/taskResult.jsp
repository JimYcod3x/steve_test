...
<div class="content">
  <c:if test="${not task.isFinished()}">
    ...
    <div class="info">
      <b>Info:</b> This page automatically reloads every 5 seconds until the
      task is finished.
    </div>
  </c:if>
  <center>
    <table id="details" class="cpd">
      ...
      <tr>
        <td># of charge point requests</td>
        ...
        <tr>
          ...
          <td>
            <c:choose>
              ...
              <c:otherwise>
                ${result.value.response} (<a
                  href="${ctxPath}/manager/operations/tasks/${taskId}/details/${result.key}/"
                  >Details</a
                >)
              </c:otherwise>
            </c:choose>
